          ...
          <p className="text-blue-200">Live users</p> */}
                ...
                <div className="flex flex-col justify-center ml-3">
                    ...
                    <label className="relative cursor-pointer p-2" htmlFor="light-switch">
                        <svg className="hidden dark:block" onClick={() => setDarkMode(!darkmode)} width="16" height="16" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg className="dark:hidden" onClick={() => setDarkMode(!darkmode)} width="16" height="16" xmlns="http://www.w3.org/2000/svg">
